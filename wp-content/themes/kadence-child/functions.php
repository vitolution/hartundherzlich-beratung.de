 ...
 * per complianz Plugin
 * 
 */
if ( !function_exists( 'gv_gtm_head_code' ) ) {
function gv_gtm_head_code(){
?>
...
})(window,document,'script','dataLayer','GTM-MD27K72P');
...
add_action('wp_head', 'gv_gtm_head_code');
}
